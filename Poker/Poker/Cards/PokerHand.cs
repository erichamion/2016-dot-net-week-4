...
namespace Poker.Cards
{
    ...
    public class PokerHand : Hand
    {
        ...
        public PokerHand(params Card[] cards)
        {
        ...
        public override int CompareHands(Hand other)
        {
            PokerHand o;
            try
            {
            ...
            if (result == 0)
            {
                ...
                do
                {
                    result = this[idx].CompareTo(o[idx]);
        ...
        private bool IsTwoPair(int maxOfAKind, Card repeatedCard)
        {
            ...
            // must be somewhere in the first 3 cards.
            bool result = false;
            if (maxOfAKind != 2)
            {
            ...
            else if (Cards[0].CompareTo(Cards[1]) * Cards[1].CompareTo(Cards[2]) == 0)
            {
